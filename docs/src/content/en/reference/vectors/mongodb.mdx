...
<PropertiesTable
  ...
  },
  {
    ...
    isOptional: true,
    description:
      "Metadata field names to declare as Atlas Vector Search filter fields. Use this for metadata fields that you query often, such as 'category' or 'tenant_id'.",
  },
]}
/>

The following example declares metadata fields for native filtered vector search:
